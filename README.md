...
**任务管理**
- **快速添加（中文魔法输入）**：一句话自动识别要素，如「明天下午3点 开会 #高」「每周五 交周报」「后天 14点到16点 团建」——支持 今天/明天/后天/大后天、周X（下周X/下下周X）、M月d号、每天/每周/每月、上午/中午/下午/晚上 N点[半]、A到B 时间段、#高/#中/#低；不识别就原样当标题
...
└── src/
    ...
    ├── utils/             # 日期时间 / quickParse（中文魔法输入）/ 统计 / 备份
